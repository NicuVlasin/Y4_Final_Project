package com.Shredded.finalProject.Database;
...
public class WarmUpDB extends SQLiteAssetHelper{

    private static final String DB_NAME = "warm_up.db";
    private static final int DB_VER = 1;


    public WarmUpDB(Context context)
    {
